...
pressio.options_set_string(options, b"historian:metrics", b"size")
...
p_input1 = libpressio.python_to_new_pressio_data(input1)
p_input2 = libpressio.python_to_new_pressio_data(input2)
...
p_output1 = libpressio.python_to_new_pressio_data(output1)
p_output2 = libpressio.python_to_new_pressio_data(output2)
