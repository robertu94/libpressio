...
public:
  ...
  struct pressio_options get_configuration_impl() const override
  {
    ...
    set(options, "pressio:highlevel", get_accumulate_configuration("pressio:highlevel", invalidation_children, std::vector<std::string>{"remove_background:compressor", "remove_background:background"}));
    return options;
  }
