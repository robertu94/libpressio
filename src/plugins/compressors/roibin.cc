...
public:
  ...
  struct pressio_options get_configuration_impl() const override
  {
    ...
    set(options, "roibin:roi_strategy", std::vector<std::string>{"coordinates", "mask"});
        ...
        set(options, "pressio:highlevel", get_accumulate_configuration("pressio:highlevel", invalidation_children, std::vector<std::string>{"pressio:nthreads", "roibin:background", "roibin:roi", "roibin:roi_strategy", "roibin:centers", "roibin:roi_size"}));
