  ...
  public:
    ...
    struct pressio_options get_configuration_impl() const override {
      ...
      set(options, "blosc:clevel:min", 0);
        ...
        set(options, "pressio:highlevel", get_accumulate_configuration("pressio:highlevel", invalidation_children, std::vector<std::string>{"pressio:lossless", "pressio:nthreads", "blosc:compressor"}));
