...
public:
  ...
  struct pressio_options get_configuration_impl() const override
  {
    ...
    set(options, "mask_interpolation:mask_mode", std::vector<std::string>{"fill", "interp"});
        ...
        set(options, "pressio:highlevel", get_accumulate_configuration("pressio:highlevel", invalidation_children, std::vector<std::string>{"pressio:nthreads", "mask_interpolation:mask_mode", "mask_interpolation:fill", "mask_interpolation:mask"}));
