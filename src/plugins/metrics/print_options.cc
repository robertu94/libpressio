...
namespace libpressio { namespace metrics { namespace print_options_ns {
...
pressio_register registration(metrics_plugins(), "print_options", [](){ return compat::make_unique<print_options_plugin>(); });
}}
}
